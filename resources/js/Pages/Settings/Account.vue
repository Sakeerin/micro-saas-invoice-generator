    ...
    <AuthenticatedLayout>
        ...
        <div class="py-8">
            <div class="mx-auto max-w-2xl sm:px-6 lg:px-8 space-y-6">
                ...
                <!-- PDPA: Export data -->
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                    <h3 class="text-sm font-semibold text-gray-700 mb-2">ส่งออกข้อมูลของฉัน (PDPA)</h3>
                    <p class="text-sm text-gray-500 mb-4">
                        ดาวน์โหลดข้อมูลส่วนตัวทั้งหมดของคุณในรูปแบบ JSON
                        ตามสิทธิ์ความเป็นส่วนตัวภายใต้ พ.ร.บ. คุ้มครองข้อมูลส่วนบุคคล (PDPA)
                    </p>
                    <a
                        :href="route('settings.account.export')"
                        class="inline-flex items-center gap-2 px-4 py-2 bg-gray-100 hover:bg-gray-200 text-gray-700 text-sm font-semibold rounded-xl transition-colors"
                    >
